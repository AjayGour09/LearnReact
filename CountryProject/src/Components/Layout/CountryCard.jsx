    ...
    <>
      <li className="border bg-[var(--color-background)] p-3 rounded-lg shadow-lg hover:scale-105 hover:shadow-2xl hover:shadow-gray-400 duration-300">
        <div>
          ...
          <div>
            <p> <b className="text-[16px] text-gray-600">Population :</b> {population}</p>
          </div>
          <div>
            <p><b className="text-[16px] text-gray-600">Region :</b> {region}</p>
          </div>
          <div>
            <p><b className="text-[16px] text-gray-600">Capital :</b> {capital[0]}</p>
          </div>
